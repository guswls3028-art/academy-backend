...
def enforce_tier_limits(
    *,
    ...
    if tier == "basic":
        allowed_types = ("ocr", "omr_grading", "homework_video_analysis", "excel_parsing", "ppt_generation", "question_segmentation", "matchup_analysis", "matchup_index_exam", "matchup_search_qna")
