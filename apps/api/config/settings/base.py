...
# Activation release follows the compatible reader/0022 deployment on every
# API/worker. Explicit false remains the write-only rollback switch; keep readers.
...
BILLING_GRACE_PERIOD_DAYS = int(os.getenv("BILLING_GRACE_PERIOD_DAYS", "30"))
# 결제 재시도 정책
