...
from apps.api.common.auth_jwt import TenantAwareTokenObtainPairView, TenantAwareTokenRefreshView
...
urlpatterns = [
    ...
    path("api/v1/token/refresh/", TenantAwareTokenRefreshView.as_view(), name="token_refresh"),
