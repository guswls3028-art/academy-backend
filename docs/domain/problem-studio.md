...
| `repo-confirmed` | HWPX package compatibility | The 2026-07-27 damaged-file incident was traced to the legacy hand-built ZIP/XML package. The replacement writer now passes package reopen, schema validation, ZIP ordering, required header/settings/content references, and preview/section text synchronization checks. |
