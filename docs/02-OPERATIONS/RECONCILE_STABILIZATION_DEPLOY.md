...
| `docs/02-OPERATIONS/RECONCILE_STABILIZATION_VERIFICATION_COMMANDS.md` | **신규.** 운영 검증 체크 커맨드(RUNNING reconcile 수, AccessDenied, SUCCEEDED→READY, Ops CE scale down). |
...
# docs/02-OPERATIONS/RECONCILE_STABILIZATION_VERIFICATION_COMMANDS.md
```
...
# 상세 검증: docs/02-OPERATIONS/RECONCILE_STABILIZATION_VERIFICATION_COMMANDS.md
```
