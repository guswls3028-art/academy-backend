...
| 목적 | 명령 (로컬 PowerShell) |
|------|-------------------------|
| **자동 배포 ON** (레포 없으면 클론 후 ON) | `pwsh scripts/v1/api-auto-deploy-remote.ps1 -Action On -RepoUrl https://github.com/OWNER/academy.git -AwsProfile default` |
| **자동 배포 ON** (이미 레포 있음) | `pwsh scripts/v1/api-auto-deploy-remote.ps1 -Action On -AwsProfile default` |
...
| **수동 배포 1회**  | `pwsh scripts/v1/api-auto-deploy-remote.ps1 -Action Deploy -RepoUrl https://github.com/OWNER/academy.git -AwsProfile default` (레포 없을 때만 -RepoUrl 필요) |
