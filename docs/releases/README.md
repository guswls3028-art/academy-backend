...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.11.19.md](v1.11.19.md) | **CURRENT** | 2026-07-27 KST | Selectable Excel student initial passwords, encrypted one-hour credential recovery, forced first-login change, and production closure |
