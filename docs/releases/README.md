...
`CURRENT`는 마지막으로 봉인한 릴리스 노트다. 현재 운영 소스·이미지는
[성공 배포 manifest](../reports/release-manifest.latest.json), 프런트 빌드는 각 운영
도메인의 `/version.json`으로 확인한다. 봉인 이후 배포를 과거 노트의 버전이나
작성 시점만으로 판정하지 않는다.
...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.12.22.md](v1.12.22.md) | **CURRENT** | 2026-09-04 KST | Read-only session exam state inspector, separate operational receipts, bounded coverage, and exact production verification |
| [v1.12.21.md](v1.12.21.md) | production-deployed / v1.12.22로 승계 | 2026-08-08 KST | Seven-day assessment, source-preserving document, public-report, UX, security, and production-identity consolidation |
...
| [v1.11.16.md](v1.11.16.md) | production-deployed / v1.11.17로 승계 | 2026-07-26 KST | Visual academy operations dashboard, explicit Alimtalk responsibility boundaries, detailed feature workflows, and frontend production closure |
| [v1.11.15.md](v1.11.15.md) | production-deployed / v1.11.16로 승계 | 2026-07-26 KST | Academy-operation-first promotion hierarchy, four-area animated navigator, organized feature guide, and frontend production closure |
