...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.12.1.md](v1.12.1.md) | **CURRENT** | 2026-07-28 KST | Hidden-bug stabilization, durable wrong-note PDF recovery, tenant-safe QnA verification, and production cleanup |
