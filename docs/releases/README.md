...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.11.13.md](v1.11.13.md) | **CURRENT** | 2026-07-26 KST | Calm Korean promotion copy, product-accurate evidence, responsive image viewing, and full frontend production closure |
