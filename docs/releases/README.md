...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.11.30.md](v1.11.30.md) | **CURRENT** | 2026-07-28 KST | Tenant-safe staff lifecycle, intuitive attendance and reimbursement operations, and immutable settlement evidence |
