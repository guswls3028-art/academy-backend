...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.11.18.md](v1.11.18.md) | **CURRENT** | 2026-07-27 KST | Toss SDK v2 automatic-billing path, encrypted billing-key lifecycle, production fail-closed controls, and guarded go-live handoff |
