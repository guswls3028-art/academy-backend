...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.12.12.md](v1.12.12.md) | **CURRENT** | 2026-07-30 KST | Enterprise mixed-order correctness workspace, auto-graded answer review, spreadsheet-speed score entry, and production verification closure |
