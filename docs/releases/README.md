...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.12.6.md](v1.12.6.md) | **CURRENT** | 2026-07-29 KST | Teacher-controlled correction completion, regular/supplement score separation, rank/percentile trends, responsive reports, and safe preprod delivery |
