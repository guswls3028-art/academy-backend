...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.11.8.md](v1.11.8.md) | **CURRENT** | 2026-07-26 KST | Single-recipient incident SMS hardening, safe tenant/reason context, at-most-once fallback delivery, and bounded deployment authentication |
