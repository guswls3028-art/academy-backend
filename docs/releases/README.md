...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.12.16.md](v1.12.16.md) | **CURRENT** | 2026-08-01 KST | Tenant-wide attendance roster ordering, account-and-PC persisted sort preference, full-list server ordering, and production continuity verification |
