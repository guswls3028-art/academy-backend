...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.8.3.md](v1.8.3.md) | **CURRENT** | 2026-07-17 KST | Ymath student/parent cumulative score viewer, automatic progression analytics, and production delivery hardening |
