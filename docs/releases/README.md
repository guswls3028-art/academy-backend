...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.12.5.md](v1.12.5.md) | **CURRENT** | 2026-07-29 KST | Teacher-owned explanation voice profiles, rights-separated references, approval learning, and isolated Tenant 2 fixture proof |
