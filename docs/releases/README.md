...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.11.22.md](v1.11.22.md) | **CURRENT** | 2026-07-27 KST | Structure-preserving cross-session exam copies, actionable workbook errors, and production incident verification |
