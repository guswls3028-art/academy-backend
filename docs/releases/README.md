...
| 버전 | 상태 | 봉인 시점 | 변경 |
|------|------|-----------|------|
| [v1.12.8.md](v1.12.8.md) ([정정](v1.12.8-errata.md)) | **CURRENT** | 2026-07-29 KST | Scalable teacher tools hub and a privacy-bounded, review-required AI problem explanation Beta |
