...
**Status:** ⚠️ HISTORICAL — daemon mode / VIDEO_WORKER_MODE / long path 등은 2026-05-10 폐기. 현재 운영 상태는 `v1.2.0.md` + `infrastructure/video-cron-jobs.md` 가 SSOT.
...
CI build reports now write to `docs/reports/ci-build.latest.md` (was `v1/reports/`).
