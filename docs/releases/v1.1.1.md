...
**Status:** ⚠️ HISTORICAL — daemon 90분 확장(`DAEMON_MAX_DURATION_SECONDS=5400`)·daemon/batch 공통 자동 enqueue 같은 daemon path 언급은 2026-05-10 폐기. 현재는 AWS Batch 단일 경로. `v1.2.0.md` 참조.
