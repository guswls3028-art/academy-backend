# 프론트·인프라 계약 및 백엔드 연동 사실 (Cursor 참조용)

추측 금지. 프론트/인프라 구현 상세는 **academyfront/docs_cursor/06-implemented-features.md** 참조.

---

## 1. 프론트·인프라 요약 (상세는 academyfront)
...
- 프론트 구현 사실 전부: **academyfront/docs_cursor/06-implemented-features.md**
- 백엔드 core·API·배포: 본 폴더 01~05, docs/배포.md
