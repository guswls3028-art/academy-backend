...
| **프로덕션 체크리스트·테스트 시나리오** | [VIDEO_BATCH_PRODUCTION_MINIMUM_CHECKLIST_AND_ROADMAP.md](../02-OPERATIONS/VIDEO_BATCH_PRODUCTION_MINIMUM_CHECKLIST_AND_ROADMAP.md) |
| **Spot/인프라 안전성 증거** | [VIDEO_BATCH_SPOT_AND_INFRA_SAFETY_EVIDENCE_REPORT.md](../03-REPORTS/VIDEO_BATCH_SPOT_AND_INFRA_SAFETY_EVIDENCE_REPORT.md) |
| **서비스 런칭 설계(GPT용)** | [VIDEO_BATCH_SERVICE_LAUNCH_DESIGN_FOR_GPT.md](VIDEO_BATCH_SERVICE_LAUNCH_DESIGN_FOR_GPT.md) |
