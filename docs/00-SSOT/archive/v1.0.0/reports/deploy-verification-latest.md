...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-03-11T07:01:55.1357051+09:00 |
| 리전 | ap-northeast-2 |
...
| /health 200 | OK 239ms | curl 위 URL 또는 ALB DNS 직접 호출 |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 23 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 239ms (기준 p95 &lt; 2s, 샘플 1회) |
