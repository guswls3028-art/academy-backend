...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-03-11T06:17:35.5295800+09:00 |
| 리전 | ap-northeast-2 |
...
| ALB target health | 0 / 2 healthy | AWS Console EC2 > Target Groups > academy-v1-api-tg |
| /health 200 | unreachable  | curl 위 URL 또는 ALB DNS 직접 호출 |
| API 공개 URL(도메인) /health | unreachable | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 22 | reports/audit.latest.md, Batch Console |
...
- **FAIL** [API] /health unreachable: Response status code does not indicate success: 400 (Bad Request).
- **FAIL** [API] ALB target healthy 0 / 2
- **WARNING** [API] API 공개 URL /health unreachable: https://api.hakwonplus.com/healthz — Response status code does not indicate success: 404 (Not Found).
