...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-03-06T03:45:29.8165092+09:00 |
| 리전 | ap-northeast-2 |
...
| ALB target health | 0 / 1 healthy | AWS Console EC2 > Target Groups > academy-v1-api-tg |
| /health 200 | unreachable  | curl 위 URL 또는 ALB DNS 직접 호출 |
| AI/Messaging ASG | 1/1 | reports/audit.latest.md (asgAi*, asgMessaging*) |
| SQS queue 연결·DLQ | Messaging depth error DLQ 0 / AI depth error DLQ  | SQS Console 또는 get-queue-attributes |
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 7 | reports/audit.latest.md, Batch Console |
...
| DLQ 적재 없음 | Messaging DLQ=0 AI DLQ= | get-queue-attributes ApproximateNumberOfMessages (DLQ) |
| **섹션 4 종합** | **PASS** | |
...
### 발견 사항(리스크)
- **WARNING** [Drift] SSOT와 불일치 3건: Batch CE/academy-v1-video-ops-ce, ASG/academy-v1-api-asg, API LT/academy-v1-api-lt
