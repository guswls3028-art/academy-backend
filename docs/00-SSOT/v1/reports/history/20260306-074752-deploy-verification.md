...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-03-06T07:46:32.4152946+09:00 |
| 리전 | ap-northeast-2 |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 18 | reports/audit.latest.md, Batch Console |
...
### 발견 사항(리스크)
- **WARNING** [Drift] SSOT와 불일치 3건: ASG/academy-v1-api-asg, ASG/academy-v1-ai-worker-asg, API LT/academy-v1-api-lt
