...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T06:27:13.4710525+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 108ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:b60082bca7c0ee524dc7714b0f3e9008b0c358654390e72d5b1c3246762f4b02) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 108ms (기준 p95 &lt; 2s, 샘플 1회) |
