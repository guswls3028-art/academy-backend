...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-28T00:34:13.8776934+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | MISMATCH | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:aafdc00fcadf1a7f28bdad871965dac3255771c04ccc95e5d924bc09d657536d) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-ma_oNKgS.js → public, max-age=31536000, immutable |
