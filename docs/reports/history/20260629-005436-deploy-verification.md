...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-29T00:53:11.4731422+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:a1ddfe6e7df51ec295cedfa6c07f5c2afeb37a403ec909c6d52a4e3e091aae75) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-2pM6GScf.js → public, max-age=31536000, immutable |
