...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-26T02:39:59.9994180+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 195ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:e045c6bc9f0d7975e821be8c9620f4512e6ca83c955d140737fbd77b71c72724) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 296 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 195ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-BP7fqG8j.js → public, max-age=31536000, immutable |
