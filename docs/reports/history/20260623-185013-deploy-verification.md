...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-23T18:48:54.0252205+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 76ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:ebae00455adaa75984cd5d9c88ea0f38cd5b69956db19b05c4845e448be65efa) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 76ms (기준 p95 &lt; 2s, 샘플 1회) |
