...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-19T13:59:37.8621250+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 82ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:22a266d8fb9a9e8e9b84133f6faaf69aa94f56641d9e9cb55879870f1b39502a) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 285 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 82ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-Xim3wskY.js → public, max-age=31536000, immutable |
