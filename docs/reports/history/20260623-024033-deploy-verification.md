...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-23T02:39:12.4898529+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:197e791dc2ecae28f9bfcfc1b112f3de8499ea78a33fb82d1b4b46fcac1c1c7c) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 246 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-Bm38K7hn.js → public, max-age=31536000, immutable |
