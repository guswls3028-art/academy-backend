...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T08:25:36.8813406+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 106ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:ee296e0119f33ee334fd87110cf614f4be75d2d82a7ab2fec24a43b97202334f) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 258 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 106ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-2IfKChQs.js → public, max-age=31536000, immutable |
