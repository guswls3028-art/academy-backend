...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-19T17:49:13.3074804+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 65ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:366b520e41cdc320e432ad20d7b622d31c3b8f0979a3389bf39f01d853568a60) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 287 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 65ms (기준 p95 &lt; 2s, 샘플 1회) |
