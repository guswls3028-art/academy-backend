...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-20T02:25:14.9460028+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:362a6e717e85498f816be3d644d5ca525bf7dde8b8210f872271a66e65d31782) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 289 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-COHnmGp9.js → public, max-age=31536000, immutable |
