...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-26T05:34:36.0832414+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 131ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:dc823c5035cbce0bf84fa786650a92eae255d0e00ed04c3aa44dda318f085f08) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 299 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 131ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-ADohAhmS.js → public, max-age=31536000, immutable |
