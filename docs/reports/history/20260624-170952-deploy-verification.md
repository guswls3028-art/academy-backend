...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:3b6f10a1c8ed3bf171979decdfd792b3aea87b11c8249f8df4a9b0cd5546e9c6) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-B6wMkbVg.js → public, max-age=31536000, immutable |
