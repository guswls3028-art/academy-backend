...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T01:34:17.4700329+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 445ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:560e62444c541e5550c002c6ad2ebf498f70ee50b5e11fb6878f12fc85f590f9) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 255 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 445ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CQ6Ju8Y9.js → public, max-age=31536000, immutable |
