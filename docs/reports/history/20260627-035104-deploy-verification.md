...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T03:49:12.4804834+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 85ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:24197a9f8ce27f883cf90655de25ea84e65ab73887725e65766d196c6d394abf) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 256 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 85ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CQc0lKR1.js → public, max-age=31536000, immutable |
