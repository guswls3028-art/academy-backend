...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-25T04:56:25.5382580+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:3c6ca30485c406683fa4f11a3ae4e7e29f4e29707aef8a35c42d159dde681679) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-C7tSFsLO.js → public, max-age=31536000, immutable |
