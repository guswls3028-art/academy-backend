...
| API 공개 URL(도메인) /health | OK 174ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:66e467b5f50f70ef9273a7ca4c0954d17fa09cd1cff99a806e53777fb2a81917) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 174ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DjIvJlyu.js → public, max-age=31536000, immutable |
