...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-28T19:10:55.9474166+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 70ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 70ms (기준 p95 &lt; 2s, 샘플 1회) |
...
- [audit.latest.md](./20260728-191245-464-5e4f2e9d/audit.latest.md)
- [drift.latest.md](./20260728-191245-464-5e4f2e9d/drift.latest.md)
- [runtime-images.latest.md](./20260728-191245-464-5e4f2e9d/runtime-images.latest.md)
- [consistency.latest.md](./20260728-191245-464-5e4f2e9d/consistency.latest.md)
- [front-connection.latest.md](./20260728-191245-464-5e4f2e9d/front-connection.latest.md)
- [release-manifest.latest.json](./20260728-191245-464-5e4f2e9d/release-manifest.latest.json)
