...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-08T23:28:24.6284774+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 100ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:8fdff8796b9ce602e91f1724bdff019b35898a33535738c02c31312bd9087fce) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 279 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 100ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CUYuq4lv.js → public, max-age=31536000, immutable |
