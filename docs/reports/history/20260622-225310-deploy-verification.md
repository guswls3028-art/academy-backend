...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-22T22:51:46.3937313+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:c53b2928d44402226b1bd0f89af8e10017061ff3dc4fc6499736b3c49d1e7c5e) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 245 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-t0mSpJQ7.js → public, max-age=31536000, immutable |
