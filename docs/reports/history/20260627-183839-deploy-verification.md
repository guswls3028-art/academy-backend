...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T18:36:57.6915799+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 181ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | MISMATCH | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:e7bf5b81ade1ff5864883c13c7785fe3ee3e8101479075f37ac1ff00e1712bfa) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 265 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 181ms (기준 p95 &lt; 2s, 샘플 1회) |
