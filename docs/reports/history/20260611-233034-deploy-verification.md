...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-11T23:29:27.7257295+09:00 |
| 리전 | ap-northeast-2 |
...
| /health 200 | OK 14ms | curl 위 URL 또는 ALB DNS 직접 호출 |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 14ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-BjtWjzXV.js → public, max-age=31536000, immutable |
