...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-14T19:59:41.6048033+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 89ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:a62c8886929c923b5da8d3102083d1b94c11b464ae9cf55a614fc6761fb8ab49) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 282 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 89ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-Dgm3VXhd.js → public, max-age=31536000, immutable |
