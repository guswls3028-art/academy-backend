...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-26T02:04:16.9101191+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 98ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:69739f313036a8589c2a27022c54cfd9a5341fa926baab237c27aa3aa606329c) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 295 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 98ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DbT_5-Qi.js → public, max-age=31536000, immutable |
