...
| API 공개 URL(도메인) /health | OK 25ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:c8bbadd4f37c59cca9ee79c73879e530928cf444bcf974b7cdc7e76bc587772a) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-D38lLrXh.js → public, max-age=31536000, immutable |
...
- [audit.latest.md](./20260728-122223-206-7b3e4496-audit.md)
- [drift.latest.md](./20260728-122223-206-7b3e4496-drift.md)
- [runtime-images.latest.md](./20260728-122223-206-7b3e4496-runtime-images.md)
- [consistency.latest.md](./20260728-122223-206-7b3e4496-consistency.md)
- [front-connection.latest.md](./20260728-122223-206-7b3e4496-front-connection.md)
- [release-manifest.latest.json](./20260728-122223-206-7b3e4496-release-manifest.json)
