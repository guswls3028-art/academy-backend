...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-01T20:48:04.8754806+09:00 |
| 리전 | ap-northeast-2 |
...
| /health 200 | OK 37ms | curl 위 URL 또는 ALB DNS 직접 호출 |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 211 | reports/audit.latest.md, Batch Console |
