...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-23T19:33:20.6365359+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 113ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:b82d4425ffb783a36d384cfc34b1b9e3ba57c8fbfeb0650dbcab8fc5e34061dd) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 247 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 113ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-1nOVDZzQ.js → public, max-age=31536000, immutable |
