...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-05-28T02:06:15.5501027+09:00 |
| 리전 | ap-northeast-2 |
...
### 발견 사항(리스크)
- **WARNING** [Drift] SSOT와 불일치 4건: Batch CE/academy-v1-yolo-gpu-ce, Batch Queue/academy-v1-tools-queue, Batch Queue/academy-v1-yolo-gpu-queue, ASG/academy-v1-tools-worker-asg
