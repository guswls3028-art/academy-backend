...
| /health 200 | OK 26ms | curl 위 URL 또는 ALB DNS 직접 호출 |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 26ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-UCX14m4D.js → public, max-age=31536000, immutable |
