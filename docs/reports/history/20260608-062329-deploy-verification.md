...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-08T06:21:58.4129218+09:00 |
| 리전 | ap-northeast-2 |
...
| /health 200 | OK 28ms | curl 위 URL 또는 ALB DNS 직접 호출 |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 228 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DDo4A-KB.js → public, max-age=31536000, immutable |
