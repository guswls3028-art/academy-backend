...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-14T23:26:01.3153637+09:00 |
| 리전 | ap-northeast-2 |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 234 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CumqeLzQ.js → public, max-age=31536000, immutable |
