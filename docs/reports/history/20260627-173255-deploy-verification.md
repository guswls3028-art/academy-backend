...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T17:31:09.1629151+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | MISMATCH | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:50fef2ae903de79b63fd8b7ba76e6572539716051310e4889467bc6460265124) |
| AI/Messaging ASG | 0/0 | reports/audit.latest.md (asgAi*, asgMessaging*) |
| SQS queue 연결·DLQ | Messaging depth 0 (in-flight 0) DLQ 0 / AI depth 0 (in-flight 0) DLQ 0 | SQS Console 또는 get-queue-attributes |
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 264 | reports/audit.latest.md, Batch Console |
