...
**Generated:** 2026-05-28T02:06:39.6059925+09:00
...
| Batch CE | academy-v1-yolo-gpu-ce | not in SSOT | VALID/ENABLED | Review |
| Batch Queue | academy-v1-video-batch-queue | exists | exists | NoOp |
| Batch Queue | academy-v1-video-ops-queue | exists | exists | NoOp |
| Batch Queue | academy-v1-tools-queue | exists | missing | Create |
| Batch Queue | academy-v1-yolo-gpu-queue | not in SSOT | VALID/ENABLED | Review |
...
| ASG | academy-v1-tools-worker-asg | Min= Max= Desired= | Min=1 Max=2 Desired=1 | Update |
