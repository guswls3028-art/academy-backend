...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-09T16:06:46.0087987+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:6c5379a9aa835199e71c284ec40ccbe390acef983a1c3ba468626e0f2da2ae0b) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-Dl3rbP8C.js → public, max-age=31536000, immutable |
