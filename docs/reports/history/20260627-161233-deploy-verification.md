...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T16:10:49.2962958+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:39e1b04e521c46cd8d396649de9900381f72c840a5840e34bf714f3e4079b3a5) |
| AI/Messaging ASG | 3/0 | reports/audit.latest.md (asgAi*, asgMessaging*) |
| SQS queue 연결·DLQ | Messaging depth 0 (in-flight 0) DLQ 0 / AI depth 0 (in-flight 2) DLQ 0 | SQS Console 또는 get-queue-attributes |
