...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T09:32:32.6012217+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:90c40d955ea0f7bfd0bae01ff310d4b1e0528ba767cb7b359622fd75788f1978) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 259 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-B35b9th_.js → public, max-age=31536000, immutable |
