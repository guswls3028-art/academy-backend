...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-17T04:32:14.2837624+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 83ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:d55d65e3e267e2ba25a0bd3ce2bb243995bb6d7ce83d43febb2e7e45672a72e6) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 284 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 83ms (기준 p95 &lt; 2s, 샘플 1회) |
