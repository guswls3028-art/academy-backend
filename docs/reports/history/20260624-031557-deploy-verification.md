...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-24T03:14:37.0646458+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 69ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:a8e4f41329f056fb87e9130ef3a89a84e1c9f8ad8dfc47e819ca5f4ac823a713) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 248 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 69ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-BVu_68HQ.js → public, max-age=31536000, immutable |
