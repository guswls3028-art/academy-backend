...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-08T22:57:30.0613633+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 96ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:0b52eead446d0feee1111e32b2e125f35ef8ed55b419b708d73eb3a28ec468dc) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 278 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 96ms (기준 p95 &lt; 2s, 샘플 1회) |
