...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-26T07:40:27.8604928+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 137ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:e8eaddf994128a93068442014ca9ff3da28907a0c088840987ced2eb0c2b7a00) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 301 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 137ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-5x5I9SXl.js → public, max-age=31536000, immutable |
