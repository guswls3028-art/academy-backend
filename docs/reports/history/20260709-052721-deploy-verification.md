...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-09T05:25:54.3897467+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 87ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:b107e603ac5339b79d176af1371e07af962687b6038866df0a00a556092d3dbc) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 87ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-cZmFb2kS.js → public, max-age=31536000, immutable |
