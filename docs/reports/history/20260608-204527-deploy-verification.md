...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-08T20:44:25.8480356+09:00 |
| 리전 | ap-northeast-2 |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-BvbUqiYv.js → public, max-age=31536000, immutable |
