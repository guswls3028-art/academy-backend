...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-22T20:48:59.6937542+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 63ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:ce0773b25dbab2a988459268e6d8d9e404d0f8869f1dffbfc30adb8ec6f6b8dc) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 63ms (기준 p95 &lt; 2s, 샘플 1회) |
