...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-24T20:58:28.3404947+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 105ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 105ms (기준 p95 &lt; 2s, 샘플 1회) |
