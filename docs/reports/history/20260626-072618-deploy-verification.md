...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-26T07:25:06.8606809+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:7b6654f8c251037993c8541a484581fd6e836bf3b335a145e24c5a2415843900) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 253 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-D3nq2Bpx.js → public, max-age=31536000, immutable |
