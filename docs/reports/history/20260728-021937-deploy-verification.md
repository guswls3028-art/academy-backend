...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-28T02:18:07.1196893+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 153ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:0cd3c007d8fc2ee6da8a2b3e877fbcac3a350fad53c23d8be62685546725dd4c) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 313 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 153ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-Cta_d8tH.js → public, max-age=31536000, immutable |
