...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-24T09:00:37.7073555+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 75ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:548baa4fc3cfae41ae3b569471910408d03464cf6b8a39a03ac12a81b26e8913) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 249 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 75ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CY-Xn3gx.js → public, max-age=31536000, immutable |
