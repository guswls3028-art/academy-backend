...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-19T16:25:35.6760988+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 117ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:b6a029faf9e83c3ef855928c72be326e9b16496840adbbb4e55b06433e0580eb) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 286 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 117ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DubE-iSf.js → public, max-age=31536000, immutable |
