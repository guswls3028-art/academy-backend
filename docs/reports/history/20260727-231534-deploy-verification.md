...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-27T23:12:37.6065372+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 159ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:8b8b4979d2d2777c970b405e2e78beffeca5403d7667891bf9fc395f304b13da) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 309 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 159ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-BSBdqiJm.js → public, max-age=31536000, immutable |
