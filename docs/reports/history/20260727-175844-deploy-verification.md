...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-27T17:56:24.0335983+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 155ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:66abcde828511d887c82a81ceb86f372ca8f00669cc52be03482b166e6395287) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 304 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 155ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CoIDfJkc.js → public, max-age=31536000, immutable |
