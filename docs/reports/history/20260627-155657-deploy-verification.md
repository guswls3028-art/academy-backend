...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-27T15:55:09.0607295+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 91ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | MISMATCH | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:39e1b04e521c46cd8d396649de9900381f72c840a5840e34bf714f3e4079b3a5) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 91ms (기준 p95 &lt; 2s, 샘플 1회) |
