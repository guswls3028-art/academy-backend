...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-20T18:50:28.5134285+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:5951366b24db8a44690058dbb3a67cc5c21d457bdfaab518f3cab7551493dbae) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 292 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CziwUn8u.js → public, max-age=31536000, immutable |
