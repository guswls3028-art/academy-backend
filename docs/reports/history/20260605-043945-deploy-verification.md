...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-05T04:38:48.0441522+09:00 |
| 리전 | ap-northeast-2 |
...
| /health 200 | OK 19ms | curl 위 URL 또는 ALB DNS 직접 호출 |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 217 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 19ms (기준 p95 &lt; 2s, 샘플 1회) |
