...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-09T17:00:02.9216252+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 101ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:8056ec1392df25afa24123edee35d39ba2d2e66a367b662d483e789fe493d1bf) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 101ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CfLIgdhE.js → public, max-age=31536000, immutable |
