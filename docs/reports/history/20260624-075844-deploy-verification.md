...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-24T07:57:22.1025884+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 94ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:77775580fe0943c5bea05968a9b1e022d7e649dc282b1a795b642aeaf9b5ae0c) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 94ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CsAal8oY.js → public, max-age=31536000, immutable |
