...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-26T10:06:40.5993809+09:00 |
| 리전 | ap-northeast-2 |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DRtN9dEA.js → public, max-age=31536000, immutable |
