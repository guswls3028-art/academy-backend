...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-21T06:47:27.9787503+09:00 |
| 리전 | ap-northeast-2 |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 240 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-BmxPMTbI.js → public, max-age=31536000, immutable |
