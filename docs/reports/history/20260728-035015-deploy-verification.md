...
| API 공개 URL(도메인) /health | OK 125ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:8a94c07b579a66a3f355dc883f832b59ff5cc489ceb5422d66fcd19c50321645) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 314 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 125ms (기준 p95 &lt; 2s, 샘플 1회) |
