...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-22T14:29:50.0042982+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 134ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:aab5af3c9b4d7ac378b079d59eeea0290c68ad66e15d00c1898fcc68962431d3) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 134ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CR1xosTP.js → public, max-age=31536000, immutable |
