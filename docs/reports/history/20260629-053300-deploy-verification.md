...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-29T05:31:16.7510525+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 126ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:ad945f4c99646411da758fcd9c6f91912a88ff0579bec8d866d3380ffb967801) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 272 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 126ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DcQDShRi.js → public, max-age=31536000, immutable |
