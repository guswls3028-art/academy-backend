...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-25T09:06:54.1842538+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 84ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:9cb098a33fff388e11936d923546f74e43b5fa4ab7ace3fbac3bc31642494f6e) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 84ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-Ddhtt-fJ.js → public, max-age=31536000, immutable |
