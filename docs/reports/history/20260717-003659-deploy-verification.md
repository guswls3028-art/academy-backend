...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-17T00:35:50.8066369+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:be6390a8630b77a8d93153c5e1a4c916f0e04766bf8eb25cbbc43cd8052f9614) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 283 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CmKODs0F.js → public, max-age=31536000, immutable |
