...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-22T03:45:17.9481705+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 67ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:660ada594fc98ba15040f9b006e78a8f1fe28b5d1e87eb494867fbca5cce1ff1) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 243 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 67ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DZZQNjHQ.js → public, max-age=31536000, immutable |
