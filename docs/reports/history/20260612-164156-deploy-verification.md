...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-12T16:40:59.0198073+09:00 |
| 리전 | ap-northeast-2 |
...
| /health 200 | OK 16ms | curl 위 URL 또는 ALB DNS 직접 호출 |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 16ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-W1ROm2l2.js → public, max-age=31536000, immutable |
