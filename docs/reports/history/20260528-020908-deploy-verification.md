...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-05-28T02:08:10.6881898+09:00 |
| 리전 | ap-northeast-2 |
...
### 발견 사항(리스크)
- **WARNING** [Drift] SSOT와 불일치 3건: Batch CE/academy-v1-yolo-gpu-ce, Batch Queue/academy-v1-tools-queue, Batch Queue/academy-v1-yolo-gpu-queue
