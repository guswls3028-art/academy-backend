...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-27T21:23:46.8521771+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 127ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:eb6f5192b5964c47cf883951179b1ccdd292f23b9bdb0fff40d1658c5f172b82) |
| AI/Messaging ASG | 3/1 | reports/audit.latest.md (asgAi*, asgMessaging*) |
| SQS queue 연결·DLQ | Messaging depth 0 (in-flight 0) DLQ 0 / AI depth 0 (in-flight 0) DLQ 0 | SQS Console 또는 get-queue-attributes |
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 307 | reports/audit.latest.md, Batch Console |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CcOycedr.js → public, max-age=31536000, immutable |
