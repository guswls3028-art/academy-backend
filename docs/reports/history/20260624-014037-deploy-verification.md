...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-24T01:39:11.8295394+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 81ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=2, ci=sha256:fff87998990a52126bd1388f0fe035f3d1e6cc3788b19d990aba9b6cb0f25c58) |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 81ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-3QYirdDk.js → public, max-age=31536000, immutable |
