...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-07T08:15:09.5565458+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:ba4a8f7db897e86a9b0053a51041ca77cc4eed5b307d4292aad608352ac8d6bf) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-CTeiUCkt.js → public, max-age=31536000, immutable |
