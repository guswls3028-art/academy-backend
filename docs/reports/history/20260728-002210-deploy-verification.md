...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-28T00:20:16.3491855+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 90ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:949613255dc6e41cf04930f0442613518dbfacfed968884979b8b31154e2ef56) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 311 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 90ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-BxjnxBL7.js → public, max-age=31536000, immutable |
