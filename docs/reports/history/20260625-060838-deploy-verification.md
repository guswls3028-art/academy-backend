...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-25T06:07:13.2982659+09:00 |
| 리전 | ap-northeast-2 |
...
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:ad12a51fb0e87f48a778c0fec798c8b0ee2f6481337e3332d9d80cc6edd18206) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DPYxhkYQ.js → public, max-age=31536000, immutable |
