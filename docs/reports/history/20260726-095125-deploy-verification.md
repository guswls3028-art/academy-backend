...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-26T09:49:54.1719223+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 86ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:534bfa162ea0f7eec9faa03e6d90b3e26eaf9d6fa0d9442df4fc248ecb2e2c79) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 303 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 86ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-DXZejqRo.js → public, max-age=31536000, immutable |
