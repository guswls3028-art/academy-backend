...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-05-22T10:57:02.3462311+09:00 |
| 리전 | ap-northeast-2 |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 187 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| 최소 알람 세트(API 5XX, SQS depth/DLQ, Batch failed/stuck/backlog, RDS, Redis) | 7 alarms (academy/v1) | CloudWatch > Alarms (academy/v1 필터) |
