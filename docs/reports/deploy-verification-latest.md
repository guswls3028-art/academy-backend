...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-06-24T22:22:54.2661876+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 115ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:b6a2964397baca6b094adf1e9730ab53432765fda34114f8f7bbf32dc6d28002) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 251 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 115ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-Af_G7vIP.js → public, max-age=31536000, immutable |
