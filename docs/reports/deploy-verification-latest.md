...
| 항목 | 값 |
|------|-----|
| 검증 시각 | 2026-07-08T19:02:02.6380252+09:00 |
| 리전 | ap-northeast-2 |
...
| API 공개 URL(도메인) /health | OK 109ms | API_PUBLIC_URL 또는 front.domains.api: https://api.hakwonplus.com |
| API runtime image digest | PASS | docs/reports/runtime-images.latest.md (instances=1, ci=sha256:f2b7d841dc6c70a568057e355a87afb6e8e738fddc0df4b08167ee7a8585ee1a) |
...
| Video Batch CE/Queue/JobDef | CE VALID Queue ENABLED JobDef rev 277 | reports/audit.latest.md, Batch Console |
...
| 항목 | 결과 | 근거 |
|------|------|------|
| /health | OK | 응답시간: 109ms (기준 p95 &lt; 2s, 샘플 1회) |
...
| 해시 자산(JS/CSS) Cache-Control | PASS (1년) | 샘플: https://hakwonplus.com/assets/index-BZu6mtFZ.js → public, max-age=31536000, immutable |
