...
`docs/v1/...` alias와 실제 운영 경로가 혼재되어 발생하는 오작동을 방지한다.

## Authoritative paths

- 실행 SSOT: `docs/ssot/params.yaml`
- 배포/CI 문서 SSOT: `docs/infrastructure/`
- SSOT 인덱스/정책: `docs/README.md`
- 실행 스크립트: `scripts/v1/`

## v1 alias 정책

- `docs/v1/...`는 **deprecated alias**로 취급한다.
...
- 2단계: 운영 문서(`docs/operations`)의 alias 점진 정리
