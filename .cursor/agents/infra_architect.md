...
**Constraints:** Follow .cursor/rules (00_project_context, 01_architecture, 03_scaling_logic). Use EC2 ASG + AWS Batch only; no ECS/EKS/S3/CloudFront. Do not introduce components not in infra_topology.yaml. SSOT: docs/00-SSOT/v4.
