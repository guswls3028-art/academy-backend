...
1. Read **04_cost_engine**, **03_scaling_logic**, **05_reliability_engine**. Instance types and limits: `.cursor/knowledge/infra_topology.yaml` (services.*.instance_type, limits.max_concurrency).
