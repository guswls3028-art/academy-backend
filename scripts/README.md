...
**진입점은 이 파일.** 인프라 배포·검증은 **scripts/v1** 만 사용한다.
...
v1 제외한 모든 스크립트는 **scripts/archive/** 아래에 보관했다. **실행 금지.** deploy 시 호출 스택에 archive 또는 infra가 있으면 즉시 fail.
...
- 정식 SSOT: [docs/00-SSOT/v1/SSOT.md](../docs/00-SSOT/v1/SSOT.md)
