"""Video Redis cache helpers (tenant namespace).

This adapter owns Redis key construction and cache-only status/progress helpers.
Legacy callers keep importing through apps.domains.video.redis_status_cache.
"""
